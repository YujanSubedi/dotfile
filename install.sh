...
sudo pacman -S --noconfirm --needed pipewire-jack pipewire-alsa
...
AMD)
	...
	Nvidia)
		sudo pacman -S --noconfirm --needed amd-ucode nvidia-open
		;;
	Nvidia_with_Cuda)
		sudo pacman -S --noconfirm --needed amd-ucode nvidia-open cuda cudnn
		;;
	*)
