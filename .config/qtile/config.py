...
keys = [
    ...
    Key([mod, "shift"], "q", lazy.spawn("sh -c ~/.config/qtile/lock.sh")),
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(text=' ', fontsize=18,
                               background='#282738', foreground='#CAA9E0'),

                widget.TextBox(fmt='Search', background='#282738',
                               font="JetBrains Mono Bold",
                               fontsize=13, foreground='#CAA9E0',
