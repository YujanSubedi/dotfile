...
vim.keymap.set({ "n", "v", "s", "i" }, "<A-d>", vim.diagnostic.goto_next, { desc = "Jump to next Diagnostic" })
...
vim.keymap.set("n", "<leader>ehd", "<cmd>lua vim.lsp.inlay_hint.enable(false)<cr>", { desc = "Disable inlay hint" })
