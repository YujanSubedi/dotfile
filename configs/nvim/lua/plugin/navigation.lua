return {
	{
		...
		config = function()
			...
			-- vim.keymap.set("n", "<leader>fc", builtin.colorscheme, { desc = "[F]ind [S]elect Telescope" })
			-- vim.keymap.set("n", "<leader>f", builtin.builtin, { desc = "[F]ind [S]elect Telescope" })
			-- vim.keymap.set("n", "<leader>g", builtin.builtin, { desc = "[F]ind [S]elect Telescope" })
			-- vim.keymap.set("n", "<C-f>", builtin.grep_string, { desc = "[F]ind current [W]ord" })
			-- vim.keymap.set("n", "<A-n>", vim.cmd.cnext)
			-- vim.keymap.set("n", "<A-p>", vim.cmd.cprev)
